    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_GroupCourses", x => new { x.CoursesCourseId, x.GroupsGroupId });
                    table.ForeignKey(
                        name: "FK_GroupCourses_Courses_CoursesCourseId",
                        column: x => x.CoursesCourseId,
                        principalTable: "Courses",
                        principalColumn: "CourseId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_GroupCourses_Groups_GroupsGroupId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_GroupCourses_GroupsGroupId",
                table: "GroupCourses",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TimeSlots_DayOfWeek_StartTime_EndTime",
                table: "TimeSlots",
